...
Look through the merged pull requests and see if any of them is marked with the `X-change` label.
If they are, make sure to highlight them as appropriate according to the seriousness of the change.
