...
We are happy to announce the release of Habitat 0.68.0. If you just want the binaries, head on over to [Install Habitat](https://www.habitat.sh/docs/install-habitat/).
