...
We are happy to announce the release of Chef Habitat 0.66.0. If you just want the binaries, head on over to [Install Chef Habitat](https://www.habitat.sh/docs/install-habitat/install-cli.
