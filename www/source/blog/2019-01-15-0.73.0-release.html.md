---
title: Chef Habitat 0.73.0 Released
date: 2019-01-15
author: Josh Black
tags: release notes
category: product
...
We are happy to announce the release of Chef Habitat 0.73.0. We have a number of
new features as well as bug fixes, so please read on for all the details. If you just want the
binaries, head on over to [Install Chef Habitat](https://www.habitat.sh/docs/using-habitat/#install-habitat).
