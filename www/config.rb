...
redirect '/docs/reference/#plan-settings', to:'/docs/reference/plan-settings'
redirect 'docs/reference/callbacks/index.html', to: '/docs/reference/build-phase-callbacks'
redirect '/docs/reference/#reference-callbacks', to:'/docs/reference/build-phase-callbacks'
redirect 'docs/reference/build-variables/index.html', to: '/docs/reference/plan-variables'
redirect '/docs/reference/#plan-variables', to: '/docs/reference/plan-variables'
redirect 'docs/reference/hooks/index.html', to: '/docs/reference/reference-hooks'
redirect '/docs/reference/#reference-hooks', to: '/docs/reference/reference-hooks'
redirect 'docs/reference/runtime-settings/index.html', to: '/docs/reference/template-data'
redirect '/docs/reference/#template-data', to: '/docs/reference/template-data'
redirect 'docs/reference/utility-functions/index.html', to: '/docs/reference/#utility-functions'
redirect '/docs/reference/utility-functions', to:'/docs/reference/utility-functions'
redirect 'docs/reference/environment-vars/index.html', to: '/docs/reference/environment-variables'
redirect '/docs/reference/#environment-variables', to: '/docs/reference/environment-variables'
redirect '/docs/reference/#handlebars-helpers', to: '/docs/reference/plan-helpers'
redirect 'docs/reference/package-contents/index.html', to: '/docs/reference/package-contents'
redirect '/docs/reference/#package-contents', to: '/docs/reference/package-contents'
redirect 'docs/reference/log-keys/index.html', to: '/docs/reference/sup-log-keys'
redirect '/docs/reference/#sup-log-keys', to: '/docs/reference/sup-log-keys'
