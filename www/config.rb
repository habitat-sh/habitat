...
redirect 'docs/try/index.html', to: '/docs/install-habitat/install-cli'
redirect 'download/index.html', to: '/docs/install-habitat/install-cli'
redirect 'downloads/index.html', to: '/docs/install-habitat/install-cli'
