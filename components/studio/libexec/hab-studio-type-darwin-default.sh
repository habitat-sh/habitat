...
studio_enter_command="$libexec_path/hab pkg exec core/hab-backline bash --login +h"
studio_build_environment=
studio_build_command=""
studio_run_environment=
studio_run_command="$libexec_path/hab pkg exec core/hab-backline bash --login"
