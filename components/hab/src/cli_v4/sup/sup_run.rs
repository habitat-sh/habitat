...
pub struct SupRunOptions {
    ...
    #[arg(long = "ctl-server-certificate", default_value = HAB_CTL_KEYS_CACHE)]
    pub ctl_server_certificate: Option<CertificateChainCli>,

    /// The control gateway server’s private key.
    #[arg(long = "ctl-server-key", default_value = HAB_CTL_KEYS_CACHE)]
    pub ctl_server_key: Option<PrivateKeyCli>,

    /// The client CA certificate.
    #[arg(long = "ctl-client-ca-certificate", default_value = HAB_CTL_KEYS_CACHE)]
