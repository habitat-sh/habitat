...
#[command(disable_version_flag = true,
          help_template = "{name} {version} {author-section} {about-section} \n{usage-heading} \
                           {usage}\n\n{all-args}\n")]
pub(super) struct OriginDeleteOptions {
    ...
    pub(super) async fn do_delete(&self, ui: &mut UI) -> HabResult<()> {
        ...
        match api_client.delete_origin(&self.origin, &token).await {
            ...
            Err(api_client::Error::APIError(StatusCode::CONFLICT, msg)) => {
                ...
                ui.fatal(
                    "Before you can delete this origin, delete all package artifacts, \
                ...
                ui.fatal(
                    "Delete any package plan connections (projects) under \"Settings\" for \
                ...
                ui.fatal(
                    "Delete any origin integrations under \"Integrations\" in the Builder web \
                     UI.",
                )?;
                ui.fatal(
