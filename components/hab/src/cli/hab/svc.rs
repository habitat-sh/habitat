...
pub struct SvcStop {
    ...
    #[clap(name = "SHUTDOWN_TIMEOUT", long = "shutdown-timeout")]
...
pub struct SharedLoad {
    ...
    #[clap(long = "channel", default_value = &*CHANNEL_IDENT_DEFAULT)]
    #[serde(default)]
    ...
    #[clap(long = "group", default_value = &*GROUP_DEFAULT)]
    ...
    // based format.
    #[clap(long = "health-check-interval", short = "i", default_value = "30")]
    ...
    /// DEPRECATED
    #[clap(long = "application", short = "a", takes_value = false, hidden = true)]
    #[serde(skip)]
    ...
    // See https://github.com/habitat-sh/habitat/issues/7339
    /// DEPRECATED
    #[clap(long = "environment", short = "e", takes_value = false, hidden = true)]
    #[serde(skip)]
