...
pub struct Service {
    ...
    package_ident: ::protobuf::SingularField<::std::string::String>,
    cfg: ::protobuf::SingularField<::std::vec::Vec<u8>>,
    pkg: ::protobuf::SingularField<::std::vec::Vec<u8>>,
...
impl Service {
        ...
        unsafe {
            instance.get(|| {
                Service {
                    ...
                    package_ident: ::protobuf::SingularField::none(),
                    cfg: ::protobuf::SingularField::none(),
                    pkg: ::protobuf::SingularField::none(),
                    sys: ::protobuf::SingularField::none(),
                    unknown_fields: ::protobuf::UnknownFields::new(),
                    cached_size: ::std::cell::Cell::new(0),
                }
            })
    ...
    // optional string package_ident = 9;
    ...
    // Param is passed by value, moved
    pub fn set_package_ident(&mut self, v: ::std::string::String) {
        self.package_ident = ::protobuf::SingularField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_package_ident(&mut self) -> &mut ::std::string::String {
    ...
    // Take field
    pub fn take_package_ident(&mut self) -> ::std::string::String {
        self.package_ident.take().unwrap_or_else(|| ::std::string::String::new())
    }

    pub fn get_package_ident(&self) -> &str {
        match self.package_ident.as_ref() {
            Some(v) => &v,
            None => "",
        }
    }
    ...
    // Param is passed by value, moved
    pub fn set_pkg(&mut self, v: ::std::vec::Vec<u8>) {
        self.pkg = ::protobuf::SingularField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_pkg(&mut self) -> &mut ::std::vec::Vec<u8> {
        if self.pkg.is_none() {
    ...
    // Take field
    pub fn take_pkg(&mut self) -> ::std::vec::Vec<u8> {
        self.pkg.take().unwrap_or_else(|| ::std::vec::Vec::new())
    }

    pub fn get_pkg(&self) -> &[u8] {
    ...
    pub fn take_sys(&mut self) -> ::std::vec::Vec<u8> {
        self.sys.take().unwrap_or_else(|| ::std::vec::Vec::new())
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !try!(is.eof()) {
            ...
            match field_number {
                ...
                9 => {
                    try!(::protobuf::rt::read_singular_string_into(wire_type, is, &mut self.package_ident));
                },
                10 => {
                    try!(::protobuf::rt::read_singular_bytes_into(wire_type, is, &mut self.cfg));
                },
                11 => {
                    try!(::protobuf::rt::read_singular_bytes_into(wire_type, is, &mut self.pkg));
                },
                12 => {
                    try!(::protobuf::rt::read_singular_bytes_into(wire_type, is, &mut self.sys));
                },
                _ => {
                    try!(::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields()));
                },
    ...
    fn descriptor_static(_: ::std::option::Option<Service>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_string_accessor(
                    "package_ident",
                    Service::has_package_ident,
                    Service::get_package_ident,
                ));
...
impl ::std::cmp::PartialEq for Service {
    fn eq(&self, other: &Service) -> bool {
        ...
        self.package_ident == other.package_ident &&
        self.cfg == other.cfg &&
        self.pkg == other.pkg &&
        self.sys == other.sys &&
        self.unknown_fields == other.unknown_fields
        ...
        while !try!(is.eof()) {
            ...
            match field_number {
                ...
                2 => {
                    ...
                    self.payload = ::std::option::Option::Some(Swim_oneof_payload::ping(try!(is.read_message())));
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    };
                    self.payload = ::std::option::Option::Some(Swim_oneof_payload::ack(try!(is.read_message())));
                },
                4 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    };
                    self.payload = ::std::option::Option::Some(Swim_oneof_payload::pingreq(try!(is.read_message())));
                },
                5 => {
        ...
        while !try!(is.eof()) {
            ...
            match field_number {
                ...
                4 => {
                    ...
                    self.payload = ::std::option::Option::Some(Rumor_oneof_payload::member(try!(is.read_message())));
                },
                5 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    };
                    self.payload = ::std::option::Option::Some(Rumor_oneof_payload::service(try!(is.read_message())));
                },
                6 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    };
                    self.payload = ::std::option::Option::Some(Rumor_oneof_payload::service_config(try!(is.read_message())));
                },
                7 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    };
                    self.payload = ::std::option::Option::Some(Rumor_oneof_payload::service_file(try!(is.read_message())));
                },
                8 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    };
                    self.payload = ::std::option::Option::Some(Rumor_oneof_payload::election(try!(is.read_message())));
                },
                _ => {
                    try!(::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields()));
                },
...
static file_descriptor_proto_data: &'static [u8] = &[
    ...
    0x69, 0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x10, 0x03, 0x22, 0xc4, 0x02, 0x0a, 0x07, 0x53, 0x65,
    ...
    ,
    ...
    ,
    ...
    0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x4a,
    0xa7, 0x28, 0x0a, 0x06, 0x12, 0x04, 0x00, 0x00, 0x73, 0x01, 0x0a, 0x08, 0x0a, 0x01, 0x0c, 0x12,
    0x03, 0x00, 0x00, 0x12, 0x0a, 0x0a, 0x0a, 0x02, 0x04, 0x00, 0x12, 0x04, 0x02, 0x00, 0x09, 0x01,
    0x0a, 0x0a, 0x0a, 0x03, 0x04, 0x00, 0x01, 0x12, 0x03, 0x02, 0x08, 0x0e, 0x0a, 0x0b, 0x0a, 0x04,
    0x04, 0x00, 0x02, 0x00, 0x12, 0x03, 0x03, 0x02, 0x19, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x00, 0x02,
    ...
    ,
    ...
    0x02, 0x01, 0x01, 0x12, 0x03, 0x2e, 0x12, 0x1f, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x06, 0x02, 0x01,
    0x03, 0x12, 0x03, 0x2e, 0x22, 0x23, 0x0a, 0x0b, 0x0a, 0x04, 0x04, 0x06, 0x02, 0x02, 0x12, 0x03,
    ...
    ,
];
