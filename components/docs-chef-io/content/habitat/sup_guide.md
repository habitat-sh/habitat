...
Note: We recommend using a powerful machine, such as an Amazon Web Services (AWS) `c4.4xlarge` to build large amounts of software in the fastest way possible.
