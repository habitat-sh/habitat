...
If you're staunchly in the anti-curl-bash camp, you can get the latest packages from the [download links]({{< relref "install-habitat/#install-habitat" >}}) listed previously.
