...
{{< note >}}
Habitat uses the guidelines of the semantic versioning specification to determine version order. Keep in mind that including a hyphen in your version indicates that the package is a pre-release that will be given lower precedence to other versions.
{{< /note >}}
