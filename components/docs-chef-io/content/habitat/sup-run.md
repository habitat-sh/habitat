...
Information about [installing Chef Habitat](/install-habitat) and configuring your workstation can be found in the previous section.
...
For further details about these commands, including all the arguments and options they take, please consult [the hab documentation](/habitat-cli).
...
1. [Build a package](/plan-overview/#plan-builds) inside an interactive studio. Do not exit the studio after it is built.
...
For more structured ways of running the Chef Habitat Supervisor on servers, please see [Running Chef Habitat on Servers](/best-practices/running-habitat-servers).
