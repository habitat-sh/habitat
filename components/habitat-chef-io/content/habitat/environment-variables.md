...
| `HAB_SUP_UPDATE_MS` | Supervisor | 60000 | Frequency in milliseconds governing how often to check for Supervisor updates when running with an [update strategy](/docs/using-habitat#using-updates) |
