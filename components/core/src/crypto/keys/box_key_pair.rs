...
use crate::crypto::keys::UserPublicEncryptionKey;
#[derive(Debug)]
...
impl OriginPublicEncryptionKey {
    ...
    pub fn encrypt(&self, data: &[u8]) -> WrappedSealedBox {
        ...
        let anon = AnonymousBox { sender: self.named_revision.clone(),
                                  ciphertext };
...
mod test {
    use super::{super::super::test_support::*,
                BoxKeyPair,
                *};
    use crate::crypto::keys::{generate_user_encryption_key_pair,
